...
test_easy_serialize : test/test_easy_serialize.cpp libeasy_serialize.so
	g++ -x c++ --std=c++11 -Wall -W -Wconversion -DRAPIDJSON_HAS_STDSTRING=1 -Ofast -Iinclude -I../rapidjson-master/include test/test_easy_serialize.cpp -L. -leasy_serialize -o $@
